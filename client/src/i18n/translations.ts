...
export const translations: Record<Language, Translations> = {
  ...
  hi: {
    ...
    profile: 'प्रोफाइल', settings: 'सेटिंग्स', heroTitle: 'ताजे ऑर्गेनिक सब्जियाँ',
    heroSubtitle: 'विश्वस्त किसानों से', shopNow: 'अभी खरीदें', products: 'सब्जियाँ',
    product: 'सब्जी', price: 'कीमत', rating: 'रेटिंग', addToCart: 'कार्ट में जोड़ें',
    viewDetails: 'विवरण देखें', inStock: 'स्टॉक में', outOfStock: 'स्टॉक खत्म',
    ...
    total: 'कुल', freeDeliveryOver: '500+ पर मुफ्त डिलीवरी', checkout: 'ऑर्डर करें',
    ...
    termsOfService: 'शर्तें', qualityGuarantee: 'गुणवत्ता गारंटी', newsletter: 'न्यूजलेटर',
    ...
    signInDescription: 'कार्ट के लिए लॉगिन करें', authenticated: 'लॉगइन किया',
  ...
  ta: {
    ...
    profile: 'சுயவிவரம்', settings: 'அமைப்புகள்', heroTitle: 'ताज़े ऑर्गेनिक பொருட்கள்',
